 ...
 * @param preprocessOptions 预处理参数；null → preprocessor 默认
...
public record IngestRequest(
    ...
    public IngestRequest(String docId, String title, String collection, String content, String source,
                         List<String> aclRoles, SplitOptions splitOptions, String sourceFile, String parser) {
        this(docId, title, collection, content, source, aclRoles, splitOptions, null, sourceFile, parser);
    }
     ...
     */
    public IngestRequest(String docId, String title, String collection, String content, String source) {
        this(docId, title, collection, content, source, null, null, null, null, null);
    }
}
