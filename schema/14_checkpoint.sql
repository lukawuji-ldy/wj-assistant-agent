...
-- 禁止与 chat_message 混用；thread_name 存业务 threadId（如 userId:conversationId）
...
COMMENT ON TABLE GraphThread IS 'Agent Checkpoint 线程（PostgresSaver）';
COMMENT ON TABLE GraphCheckpoint IS 'Agent Checkpoint 快照（PostgresSaver）';
